...
class SiteUsuariosController extends CrudController
{
 ...
 */
   private function getModel()
   {
   		...
   		$perfil = PwSql::executeQuery($this->connection, "SITE_PERFILES", array("CVE_PERFIL", "DESC_PERFIL"), array("STATUS" => 1), array("DESC_PERFIL"));

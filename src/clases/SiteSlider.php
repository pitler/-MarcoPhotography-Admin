...
class SiteSlider extends BaseViewTemp
{
	...
	public  function getData()
	{
       ...
       // $encrypt  = 2;
        ...
        $data .= $this->getImageUploadVars("slider", "Slider");
 
        //Pintamos el modal para los archivos
        //Mandamos false si no quieremos el boton de guardar
        $data .= $this->getDetailModal(false);
        //$data .= file_get_contents('template/core/detailModal.html', true);    
